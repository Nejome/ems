            ...
            <div id="content" class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body row">
                        ...
                        <form method="POST" action="/edit-my-request/<?=$rq['request_id']?>" class="col-sm-12 col-md-6  ml-auto border-left">

                            <div class="form-group row">

                                <div class="col-md-7 ml-auto">
                                    <select name="type" dir="rtl" class="form-control">
                                        <option value="1" <?php if($rq['type'] == 1){echo 'selected';} ?>>إجازة مرضية</option>
                                        <option value="2" <?php if($rq['type'] == 2){echo 'selected';} ?>>إجازة جزئية</option>
                                        <option value="3" <?php if($rq['type'] == 3){echo 'selected';} ?>>إجازة سنوية</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row form-group">
                                ...
                                <div class="col-md-7 ml-auto">
                                    <input type="date" name="from_date" class="form-control text-center" value="<?=$rq['from_date']?>">
                                </div>
                            ...
                            <div class="form-group row form-group">
                                ...
                                <div class="col-md-7 ml-auto">
                                    <input type="date" name="to_date" class="form-control text-center" value="<?=$rq['to_date']?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="9" col="50"  name="notes" class="form-control col-8 ml-5 mr-auto text-right"><?=$rq['notes']?></textarea>
                            </div>
