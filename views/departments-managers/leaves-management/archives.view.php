                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td class="float-right col-md-2 text-center"><a href="/archives/<?=$rq['request_id']?>/display/<?=$emp['employee_id']?>" class="btn btn-success">تفاصيل الطلب</a></td>
                        </tr>
                            <?php }} ?>
